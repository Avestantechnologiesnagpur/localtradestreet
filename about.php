            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <h1 class="mb-3 text-danger">Why We Are Unique</h1>
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum <br>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae.</p>
                        <!-- <div class="row mb-4">
                            <div class="col-6">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 ">
        <div class="col">
          <div class="card h-100" style="text-align: center;">
            ...
            <div class="card-body ">
              <h5 class="card-title ">  <span class="glyphicon glyphicon-list"></span> <i class="material-icons" style="font-size:48px;">description</i><br><br>
                Millions of Listings</h5>
              <p class="card-text">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested.</p>
            </div>
          </div>
        </div>
        <div class="col ">
          <div class="card h-100" style="text-align: center;">
            ...
            <div class="card-body h-100">
              <h5 class="card-title "><i style="font-size:40px ;" class="fa">&#xf0d6;</i>
                <br>
                <br>
                Save Time & Money</h5>
              <p class="card-text">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested..</p>
        ...
        <div class="col" style="text-align: center;">
          <div class="card h-100">
            <!-- <img src="..." class="card-img-top" alt="..."> -->
            <div class="card-body h-100">
                <i class="fa fa-thumbs-up" style="font-size:34px"></i>
            &nbsp;
            <br>
            <br>
