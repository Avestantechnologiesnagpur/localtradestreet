        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="width: 1000px; margin-left:75px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="f2.php"><img src="img/avon.png" width="304px" height="278px" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Aeon Fitness Club </h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;  Ankush-2, 405, model mill square, near Anandam city, Ganeshpeth Colony, Nagpur, Maharashtra 440018</p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &nbsp;8379012498, 9373736178.</p>
             ...
             <div class="card mb-3" style="max-width: 1000px; margin-left: 192px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="f3.php"><img src="img/fit 2.jpg" width="304px" height="278px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Reactive Physiotherapy And Fitness Clinic.</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;   Saikrupa Apartment, Umred Rd, beside chaudhary Hospital ,Old Mirchi Bazaar square, Sakkardara, Nagpur, Maharashtra 440024.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  8600474988, 8600052998.</p>
                        <p class="card-text"> more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="f4.php"><img src="img/fit 33.jpg " width="304px" height="400px" style="padding: 5px 5px;"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  1st Floor, Govindam Commercial, Kadbi Chowk, Nagpur, Maharashtra 440004.</p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;   07711881139.</p>
                      <p class="card-text">more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="f5.php"><img src="img/fits 4.jpg" width="304px" height="400px" style="padding: 5px 5px;"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Om Physiotherapy Clinic and Fitness Centre</h5>
             ...
             <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="f6.php"><img src="img/fit 5.jpg" width="304px" height="400px" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">marvel fitness
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Plot No.15, near Gajanan maharaj mandir, Kamgar Colony, Subhash Nagar, Trimurtee Nagar, Nagpur, Maharashtra 440022 </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp;
                            9834007388, 8625001179.</p>
                            <p class="card-text">more info</a>
                      </div>
