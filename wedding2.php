        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 10px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="wedding3.php"> <img src="img/sabrosa.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 258, opposite chapde lawns.
                        Nagpur - 440010 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/anup.png" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Anup  Kumar Events, Films And Music Academy  </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/ak.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Ak Art & photography
                      </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/skynight.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Skynight Photo Studios
                      </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/harshil.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Harshil Digital Photo Studios </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Akruti Digital Photo & Videos</h5>
