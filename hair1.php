            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center text-lg-right">
                        <div class="d-inline-flex align-items-center">
                          <a class="text-danger px-3" href="https://www.facebook.com/profilephp?id=100064148859759">
          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100 h-300" src="img/hairmain.webp" alt="Image">
                  ...
                  <div class="carousel-item">
                      <img class="w-100" src="img/hairmain.webp" alt="Image">
                      <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
       ...
       <!-- Carousel End -->
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-right:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="hair2.php"> <img src="img/hair1.jpg" class="img-fluid w-100 h-100" alt="..." >
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Hair Make-up Studios</h5></a>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7309, Oppo Varma, beside alahabad bank, deshpande layout nagpur- 440008
                         </p>
            ...
            <!-- <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="packer4php"> <img src="img/anytime2.jpg" width="320px" height="300px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Anytime Packers & Mover</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  G-13 Gajanand Complex, first floor, Zadeshwar Chokdi , N.H. no.8, Bharuch
                          Gujrat- </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9909917238   9909917268</p>
                        more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="packer4php"> <img src="img/sai.webp " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Sai Samarth Package & Movers
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; D-16, Tirumala Aastha, Ganesh Nagar Road, Chetana Nagar,
                         Nashik - 422009 </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 9960830099</p>
                      more info</a>
                    </div>
            ...
            <!-- <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Maharaj Packer & Movers
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; House no. 100, Upendra Nagar, Cidco, 
                         Nashik - 422010 </p>
          ...
          <div class="row pt-5">
              <div class="col-lg-3 col-md-6 mb-5 py-10">
                  ...
                  <div class="d-flex justify-content-start">
                    ...
                    <a class="btn btn-outline-danger btn-square mr-2" href="https://www.facebook.com/profilephp?id=100064148859759"><i class="fab fa-facebook-f"></i></a>
