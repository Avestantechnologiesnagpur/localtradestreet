        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 10px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="electrnics3.php"> <img src="img/kohinoor.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Kohinoor Electronics</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Hitesh palace, Opposite Food Court.
                        Nagpur - 440010 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/trupti.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Trupti Electronics Mobile Gallery </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Balaji Nagar Bus Stop..
                         Nagpur - 440016.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/abhay.png " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Abhay Enterprises
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Jaitala Road, Last Bus Stop..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/ajay.jpg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/bhangadkar.png" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Bangadkar Trading Company
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Bangadkar House, Hudkeshwar Naka..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/bhatia.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Bhatia Electronics</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Savitri Apartment, Raani Durgawati Chowk..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/dwarka.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Dwarkadhis Mobile Shop</h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/frontier.png" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Frontier Electric Shop</h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/GS.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       G.G.S. Enterprises </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/GURUKRIPA.jpg" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Gurukripa Electronics</h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/ambika.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Jai Ambika Electronics</h5>
