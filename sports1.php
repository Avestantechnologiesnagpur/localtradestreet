...
<head>
    ...
    <style>
    .wrapper{
        background-image: url(img/sportall.jpg);
      ...
      <div class="container">
        <div class="card mb-3" style="max-width: 1000px;" >
            <div class="row g-0 text-danger">
              <div class="col-md-4">
                <img src="img/RBA.jpg" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">  
                <div class="card-body">
                <a href="sports2.php"><h5 class="card-title">
                    RAHBER BADMINTON ACADEMY</h5>
                    <span class="glyphicon glyphicon-envelope"></span>
                  <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Ahuja Nagar, Jaripatka Nagpur Maharashtra 440014
                    </p>
