                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/Ishani.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Ishani Enterprise</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9421800066</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">8708075812</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">info@ishanienterprise.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.ishanient.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;"> Ishani Enterprises, Prestige Pride, Chehadi Shiv, Nashik Pune Road, Nashik Road </span> &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Nashik</span> - <span style="color:#ff1717;" itemprop="postalCode">422101</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">9:00am - 9:00pm </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">9:00am - 9:00pm</span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">9:00am - 9:00pm </span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">9:00am - 9:00pm </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">9:00am - 9:00pm</span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">9:00am - 9:00pm</span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">Closed - Closed </span></td></tr>		</tbody></table>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                     ...
                     <h3 class="text-danger mb-3">Description</h3>
                        <p> Ishani Enterprises in Nashik Road, Nashik is known to satisfactorily cater to the demands of its customer base. The business came into existence in 2014 and has, since then, been a known name in its field. It stands located at Ishani Enterprises, Prestige Pride, Chehadi Shiv , Nashik Pune Road, Nashik Road-422101. It has earned stamps like Jd Verified, Jd Pay substantiating the credentials of the business.The business strives to make for a positive experience through its offerings. The accepted modes of payment such as Cash, Debit Cards, Cheques, Credit Card make every business transaction easy and seamless, contributing to making the entire process even more effective. 
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/Ishani.jpg" alt="First slide">
                                  </div>
