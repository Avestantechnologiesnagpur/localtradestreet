<DOCTYPE php>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>personal care info</title>
        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 10px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="personal2.php"> <img src="img/salon1.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Attitude Unisex Salon</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Shop No.-5, Vaibhavlaxmi Apartment, Laxmi.. ,
                        Nagpur - 440010 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon2.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Paathshala Salon Academy </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Rathsaptarni Apartments, Plot No., T-10...
                         Nagpur - 440016.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon3.png " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Mansi Beauty Parlour
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Plot No. 53, Usman Layout, Near Bus Stop..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon4.jpg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Beauty Empire </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; Beside Priyadarshini Bhagvati Collage Of Eng.
                         Nagpur - 440001 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon5.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Cuts The Unisex Salon
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Opps. Workout Gym Parvati Appaertment..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon6.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Moss The Unisex Salon</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Block no. 1-2, Prabha Suman..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon7.webp" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Page 3 The Unisex Salon </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7&8 Vaishakha Appartment, Plot no. 7..
                         Nagpur - 440012. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon8.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Sai Shradha Hair Art And Beauty Parlour</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp plot no. 11 , Manewad Cement..
                         Nagpur - 440022. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon9.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       salon At Door </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;   103 Shivram Complex, Koradi Road..
                        S Nagpur - 440001. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon10.jpg" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Shretej Beauty Saloon & Slimmimg Centre</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7&8 Plot No. 7, Rukmani Palace, WHC..  
                        Nagpur - 440016. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/salon11.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Sim's Beauty Clinic</h5>
                        
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; Plot no. v-97, Parth Niwas,
                         Nagpur - 440010.
                    </p>
