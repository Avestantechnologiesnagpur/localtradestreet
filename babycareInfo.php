            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/mohakbaby.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Mohak Baby Day Care
                                    </h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone"> 7276334778.
                                        </a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371490079" itemprop="telephone"> 7276334778.</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:contact@mohakbabydaycare.com">contact@mohakbabydaycare.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://www.mohakbabydaycare.com/" rel="nofollow"> http://www.mohakbabydaycare.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">Plot No 17 Bhaskar Govindam, appt Borkute Layout,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">  Narendra Nagar</span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode"> 440015.</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>Mohak Day Care Centre in Nagpur is one of the leading businesses in the Day Care Centres. Also known for Day Care Centres, Palnaghar ,Mohak creche,Baby Sitters, Activity Clubs, Hobby Classes, Parent Child Counselling Services, Hobby Classes For Children, Children Indoor Activity Centers, Parenting Workshops and much more. Mohak Baby Day Care Center in Narendra Nagar, Nagpur is a top player in the category Day Care Centers in the Nagpur. This well-known Establishment acts as a one-stop destination servicing customers both local and from other parts of Nagpur.
</p>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/mohak 1.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/mohak 2.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/mohak 3.jpg" alt="Third slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Baby Food</a>
                            <a href="" class="btn btn-light m-1">Baby Sitters</a>
                            <a href="" class="btn btn-light m-1">Baths</a>
                            <a href="" class="btn btn-light m-1">Books</a>
                            <a href="" class="btn btn-light m-1">Clothes</a>
                            <a href="" class="btn btn-light m-1">Creams</a>
                            <a href="" class="btn btn-light m-1">Diapers</a>
                            <a href="" class="btn btn-light m-1">Toys</a>
                            <a href="" class="btn btn-light m-1">Grooming</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-dark text-white-50  px-md-5 px-lg-10" style="margin-top: 90px;">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-phone-alt mr-2"></i>+91 7276334778</p>
                <p><i class="fa fa-envelope mr-2"></i>marketing@localtradestreet.com</p>
