...
<body>
    ...
    <div class="container-fluid p-0">
     ...
     <div class="container" style="margin-top: 100px;" >
        <div class="card mb-3"style="max-width: 1000px; height: 250px; " >
            <div class="row g-0">
              <div class="col-md-4" >
              <a href="fitness3.php"> <img src="img/absgym.jpeg" width="320px" height="250"  style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">  
                <div class="card-body">
                  <h5 class="card-title">
                  ...
                  <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Ring Road, Jafar Nagar
                    opposite Z House
                    Nagpur, Maharashtra 440013</p>
        ...
        <div class="card mb-3" style="max-width: 1000px; ">
            <div class="row g-0">
              <div class="col-md-4 w-100">
                <img src="img/nextlevelfitness.jpeg" width="320px" height="250px" style="padding: 5px 5px;" img-fluid rounded-start alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">
                    NXT Level Fitness Unisex Multi Gym</h5>
                  <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  DASWA COMPLEX, DAHU TOLI
                    Dhurwa Dam Side Road
                    Ranchi, Jharkhand 834004</p>
                    <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 7004518395</p>
                    <a href="">More info</a>
                  </div>
        ...
        <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 193px; height: 280px; ">
            <div class="row g-0">
              <div class="col-md-4 w-100">
                <img src="img/As fitness.jpeg" width="320px" height="250px"  class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8" >
                <div class="card-body" >
                  <h5 class="card-title">A S-FITNESS
                  </h5>
                
                  <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Plot no u-24 Duchakke mention
                    Narendra Nagar
                    Nagpur, Maharashtra 440015 </p>
                  <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 98503 45804</p>
                  <a href="">More info</a>
                </div>
        ...
        <!-- <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px; height: 280px; ">
            <div class="row g-0">
              <div class="col-md-4 w-100">
                <img src="img/shindegym.jpg" width="320px" height="250px"  class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8" >
                <div class="card-body" >
                  <h5 class="card-title">Shinde Fitness Gym
                  </h5>
                
                  <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Vastu-vihar Apartment, Plot No. 27/28, But No. 175
                  CIDCO Waluj Mahanagar 1
                   Aurangabad, Maharashtra 431136 </p>
                  <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 9552864689</p>
                  <a href="">More info</a>
                </div>
                <div class="getenquiry" style="margin-left: 15px;">
                  <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
