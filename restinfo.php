...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid page-header bgimg">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">Restaurants Detail</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <a hrf="resttt.php"><h1 itemprop="name">Cherries n Chillies International Cuisine Restaurant</h1>
