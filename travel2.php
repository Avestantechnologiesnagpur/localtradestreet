        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 10px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="travel3.php"> <img src="img/nisar.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Nisargmay Tours And Travels</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Near Mata Mandir Maratoli..
                        Nagpur - 440010 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/pooja travel.webp" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Pooja Tour And Travels </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; 65, second floor Behind Tata..
                         Nagpur - 440016.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 7020838074 </p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/js travel.jpeg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"> J. h. Travels
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Office no.41, Opoosite Ashirwad....
                         Nagpur - 440010. </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 7972233577.</p>
                      <a href="">more info</a>
                    </div>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/kumare.jpg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Kumre Tour And Travels </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; Sheela Complex, Amravati Road.
                         Nagpur - 440001 </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9823533933, 9326264423.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/red hill.JPG" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Red Hill Holidays
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Payal Building, First Floor, Agrasen..
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/shivam travel.png" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Shivam Tours And Travels</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Gupta Complex, 1st Floor, Shop..
                         Nagpur - 440010. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9562365982.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/tathagat.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Tathgat Travels </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 16-B , Rahul Complex, ST Stand..
                         Nagpur - 440012. </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp; 9152558743.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/sp tour.webp" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        SP Tours And Travels</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp plot no. 28, Niranjan Society, 
                         Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9537366119.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/choudary.jpeg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Choudhary Travels</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  Krushna Kamal Apartment, Raghuji nagar..
                        S Nagpur - 440001. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9174007370</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/girikand.png" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                    Girikand Travels Pvt. Ltd. </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; plot no. 32, Central Bazar Road..
                        Nagpur - 440016. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9185245431</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry">
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/columbus.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; 62, Shikshan Society, Bajranng Nagar,
                         Nagpur - 440010.
                    </p>
                        <p class="card-text">9708539943.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
