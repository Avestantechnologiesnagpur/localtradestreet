                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/Metro-furniture-city-.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Metro Furniture City</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9130039755</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">9130039755</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">info@metrofurniturecity.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.metrometal.in/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">Padma Prem Plaza, Laxman Chawedi, Samrat Ashok Chowk, Near Mondha Naka </span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Aurangabad</span> - <span style="color:#ff1717;" itemprop="postalCode">431001</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">10.30am - 8:30pm </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">10.30am - 8:30pm  </span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">10.30am - 8:30pm  </span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">10.30am - 8:30pm  </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">10.30am - 8:30pm  </span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">10.30am - 8:30pm   </span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">10.30am - 8:30pm  </span></td></tr>		</tbody></table>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/Metro-furniture-city-.jpg" alt="First slide">
                                  </div>
