...
<head>
    <meta charset="utf-8">
    <title>Commercial Lands Info</title>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="package.html" class="nav-item nav-link">Login</a>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <!-- <h3 class="display-4 text-white text-uppercase">Commercial Land Detail</h3> -->
                <div class="d-inline-flex text-white">
                    <!-- <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p> -->
                    <!-- <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Commercial LandDetail</p> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/civil 1.png" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Brainhunt Consultants Pvt.Ltd
                                    </h1>
                                          ...
                                          <li class="list-group-item"> 
                                              ...
                                              <div class="pull-left">
                                                    <span style="font-size: 40px; color:#ff1717; vertical-align: middle;">***** </span><a href="https://www.facebook.com/Cherries-n-Chillies-1055781421145269/" target="_blank">
                                                        <amp-img src="https://www.pickeronline.com/assets/theme/images/facebook.png" alt="facebook" width="28" height="28" layout="fixed" class="i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined i-amphtml-built i-amphtml-layout" i-amphtml-layout="fixed" style="width: 28px; height: 28px; --loader-delay-offset:343ms !important;">
                                                            <img decoding="async" alt="facebook" src="https://www.pickeronline.com/assets/theme/images/facebook.png" class="i-amphtml-fill-content i-amphtml-replaced-content" style="vertical-align:middle;"></amp-img></a>&nbsp;
                                            </div>
                                              <div class="clearfix"></div>
                                          </li>
                                          
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone"> 07122246184.
                                        </a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371490079" itemprop="telephone"> 9850556674.</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:contact@brainhuntindia.com">contact@brainhuntindia.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://www.brainhuntindia.com/" rel="nofollow"> http://www.brainhuntindia.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">153, Gitanjali Apartment, Near Shivaji Skating Ground,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">  Gandhi Nagar</span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode"> 440010.</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>Alhad Sadachar
                            Brainhunt Consultants Pvt. Ltd (Brainhunt Consultants Pvt Ltd 153, Gitanjali Apartment Near Shivaji skating ground Gandhi Nagar,Nagpur-440010)
                            .
                        </br>
                        Brainhunt Consultants Pvt Ltd. is one of the leading HR solutions company in Nagpur.we are offering Manpower Recruitment, Executive Search, Temporary Staffing, Training & Development, Resume building etc.
</p>
                        <div class="d-flex justify-content-center">
                            <a class="text-danger px-2" href="https://www.facebook.com/profile.html?id=100064148859759">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="text-danger px-2" href="https://twitter.com/LocalTradeStre2">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="text-danger px-2" href="https://in.linkedin.com/company/brainhunt-consultants-private-limited/">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/brainhunt 1.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/brainhunt 2.png" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/brainhunt 3.jpg" alt="Third slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/brainhunt 4.jpg" alt="Forth slide" slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/brainhunt 5.jpg" alt="Fifth slide">
                                  </div>
                                </div>
     ...
     <div class="col-md well well-faint">
		<h2 class="title">Video</h2>
                    <hr>
					<amp-img src="https://www.pickeronline.com/assets/theme/images/not-available.png" alt="not-available" class="img-responsive i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-built i-amphtml-layout" style="margin: 0px auto; --loader-delay-offset:344ms !important;" layout="responsive" width="348" height="280" i-amphtml-layout="responsive"><i-amphtml-sizer slot="i-amphtml-svc" style="padding-top: 80.4598%;"></i-amphtml-sizer><img decoding="async" alt="not-available" src="https://www.pickeronline.com/assets/theme/images/not-available.png" class="i-amphtml-fill-content i-amphtml-replaced-content"></amp-img>
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Jobs in Accounting</a>
                            <a href="" class="btn btn-light m-1">HR</a>
                            <a href="" class="btn btn-light m-1">Banking</a>
                            <a href="" class="btn btn-light m-1">Finance</a>
                            <a href="" class="btn btn-light m-1">MNC</a>
                            <a href="" class="btn btn-light m-1">Manpower Recruitment</a>
                            <a href="" class="btn btn-light m-1">Training & Development</a>
                            <a href="" class="btn btn-light m-1">Resume building</a>
                            <a href="" class="btn btn-light m-1">Temporary Staffing</a>
                        </div>
                    </div>
                </div>
