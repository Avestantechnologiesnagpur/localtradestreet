          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="img/denties banner.png" alt="Image">
       ...
       <!-- Carousel End -->
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="bonde_dental.php"><img src="img/denties 1.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Dr.Bonde's Dental Clinic </h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;  Above Allahabad Bank, Near, Railway Crossing Rd, Nagar Vikas Hsg. Soc. Layout, Manish Nagar, Somalwada, Nagpur, Maharashtra</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="das_dental.php"><img src="img/denties 2.png" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Das Dental Clinic</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Sai Vasanshah Chauk,Main Bazar Rd,opp.indore namkeen,jarifatka,<br>nagpur -440014.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9021657446</p>
                        more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="sunil_dental.php"><img src="img/denties 3.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Dr. Sunil Chauhan Laser Dental Clinic & Orthodontist Centre</h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Office No 1, Ground Floor, Rajul Complex, Aaga Chowk, Jabalpur - 482002. </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;   9301911999.</p>
                      more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="chawla_dental.php"><img src="img/denties 4.jpg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Chawla Dental Clinic</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  near Arya Samaj, opposite Dayanand School, Jaripatka, Nagpur-440014 </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   07020545193.</p>
                        more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="shree_advance.php"><img src="img/denties 5.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Shri Advance Dental Clinic
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Aman Complex, Beed By Pass Road, 4th Complex, MIT Chowk, adjacent Indrayani Medical, Aurangabad, Maharashtra-431005 </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp;
                            07066669444.</p>
                        more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="sparsh_skindental.php"><img src="img/denties 6.png" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="rakshit_dental.php"><img src="img/denties 7.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="sameer_dental.php"><img src="img/denties 8.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
