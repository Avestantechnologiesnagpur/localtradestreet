        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="astrology2.php"> <img src="img/smitaastro.jpeg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Smietha Jjain Astrology</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Pantheon Society, Bunglow No.11.
                        Nagpur - 440010 </p>
