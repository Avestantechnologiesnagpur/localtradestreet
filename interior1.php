<DOCTYPE html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Interior Designer info</title>
          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100 h-300" src="img/Interior-Design-Banner.jpg" alt="Image">
        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-right:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="aarka.php"> <img src="img/aarka.jpeg" class="img-fluid w-100 h-100" alt="..." >
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Aarka Arichitects And Interior Designer</h5></a>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Vijay Nagar Colony Jabalpur, Jabalpur 482002.
                         </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="laxmi1.php"> <img src="img/laxmi.jpeg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Laxmi Interior And Construction
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Ward No 1 Shop No 88 Behind Mana Camp Post Office, Mana Camp,Raipur, Chhattisgarh-492015
                         Nashik - 422009 </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 9827362749</p>
                      more info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="auric1.php"><img src="img/auric.jpeg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Auric Interior
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Shop No 25,2nd floor,August Highstreet,
                          Near August Homes,Ulkanagri,Aurangabad 431009</p>
