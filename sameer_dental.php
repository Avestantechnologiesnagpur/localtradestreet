            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/denties 8.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Dr. Sameer D. Sonar Dental Clinic</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">0253-2412421</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">9890634618</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:sameer@sonarmail.com">samerr@sonarmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://sameerdsonar.com/" rel="nofollow"></a> http://sameerdsonar.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;"> shop no 3. Harijyot Apt, near Shanti Park, Matoshri Nagar, Upnagar,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">Nashik</span>, <span itemprop="addressRegion"style="color:#ff1717;">Maharashtra</span> - <span style="color:#ff1717;" itemprop="postalCode">422006</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p> shop no 3. Harijyot Apt, near Shanti Park, Matoshri Nagar, Upnagar, Nashik, Maharashtra 422006
                        <br>
                        The dental facility stands located in Nashik Road which makes it hassle-free for people from near and far alike to visit and consult the dentist
</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/sameer 1.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sameer 2.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sameer 3.jpg" alt="Third slide">
                                  </div>
				...
				<div class="clearfix"></div>s
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            ...
                            <a href="" class="btn btn-light m-1">Endosurgery</a>
                            <a href="" class="btn btn-light m-1">Flap Surgery</a>
                            <a href="" class="btn btn-light m-1">Post and Core</a>
                            <a href="" class="btn btn-light m-1">Laser Dentistry</a>
                            <a href="" class="btn btn-light m-1">Teeth Reshaping</a>
                        </div>
                    </div>
                </div>
