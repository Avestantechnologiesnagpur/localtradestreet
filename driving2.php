...
<head>
    <meta charset="utf-8">
    <title>Driving School Info</title>
    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/Driving School 2.jpg" alt="Image">
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/driving 2.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Shree Sai Driving School</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:9422842330" itemprop="telephone">08888755554</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">08888755554</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:shreesaidrivingschool@gmail.com">shreesaidrivingschool@gmail.com.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://shreesaidrivingschool.com/" rel="nofollow"></a> http://shreesaidrivingschool.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;"> Shop No. F3, Taj palace Umred Road near panchavati ashram Chitnis      Nagar,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"> Dighori</span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode">440034</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        Shree Sai Driving School in Nagpur is one of the leading businesses in the Motor Training Schools. Also known for Motor Training Schools, RTO Consultants, Driving License Consultants, Motor Training Schools For Two Wheeler, Two Wheeler Motor Training Schools For Women, Motor Training Schools For Women, Motor Training School Three Wheeler and much more.
</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/driving 3.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/driving 4.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/driving 5.jpg" alt="Third slide">
                                  </div>
                                  <!-- <div class="carousel-item">
                                    <img class="d-block w-100" src="img/bonde 4.jpg" alt="Forth slide" slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/bonde 1.jpg" alt="Fifth slide">
                                  </div> -->
                                </div>
				...
				<div class="clearfix"></div>
                     ...
                     <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Motor Training Schools</a>
                            <a href="" class="btn btn-light m-1">RTO Consultants</a>
                            <a href="" class="btn btn-light m-1">Driving License Consultants</a>
                            <a href="" class="btn btn-light m-1">Motor Training Schools For Women</a>
                            <a href="" class="btn btn-light m-1">Motor Training Schools For Two Wheeler</a>
                            <a href="" class="btn btn-light m-1">Motor Training School For Three Wheeler</a>
                            <a href="" class="btn btn-light m-1">Two Wheeler Motor Training Schools For Women</a>
                        </div>
                    </div> 
                </div>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5"
        ...
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white-50">Copyright &copy; <a href="index.html">localtradestreetnagpur.com</a>. All Rights Reserved.</a>
                </p>
            </div>
