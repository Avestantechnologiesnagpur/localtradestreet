...
<div class="signup-form">
    <form  method="post">
        ...
        <div class="form-group">
        	...
        	<input type="email" class="form-control" name="opwd" required="required">
        </div>
	
		<div class="form-group">
			<label> New Password</label>
            <input type="password" class="form-control" name="npwd" required="required">
        </div>  
		...
		<div class="form-group">
			<button type="submit" class="btn btn-primary btn-block btn-lg" name="login" onclick="myFunction()">Change Password</button>
		</div>	
    </form>
	<div class="text-center small"><a href="login.php">Back To Login</a></div>
	<!-- <div class="text-center small"><a href="forgetpassword.php">Forget Password</a></div> -->
</div>
<script>
    function myFunction()
    {
