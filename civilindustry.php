          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="img/civil industry.jpg" alt="Image">
        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="civilindustryInfo.php"><img src="img/civil 1.png" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Brainhunt Consultants Pvt.Ltd</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;   153, Gitanjali Apartment, Near Shivaji Skating Ground,
                        Gandhi Nagar, Nagpur - 440010.</p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                    9423105053, 9850556674.</p>
                      More info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 2.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Headstart Manpower Consultants</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  14/17, Ground Floor, Achraj Tower, Chindwara Road,
                        Chhaoni, Nagpur - 440013.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9823025969.</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 3.jpeg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        M R Placement <A class="C"></A></h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;   Flat No. 4, 2nd Floor, Pratapgarh Apartment Ring Road,
                        Chhatrapati Nagar Square, Nagpur - 440015.</p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;    8484041432, 8484041431.</p>
                      <a href="">more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 4.png" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Skyline Recuritment service</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  653, 2nd Floor, Raj Bhavan, Hanuman Vatika Tekdi Road, Behind Sanjay Travels,
                        Congress Nagar, Nagpur - 440012.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   9767712000, 9767721000.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 5.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Vinayak Job Consultant</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Block No.203, A Wing, Lokmat Bhawan,
                        Ramdaspeth, Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 6.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Ask Pyramid Jobs</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 101, 1st Floor , " Nirmiti House" Plot 280, Beside Ambedkar Law College Gate, Bajaj Nagar, N
                        Abhyankar Nagar, Nagpur - 440010.
                    </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   9265124538.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 7.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Elite Associates</h5>
                      <p class="card-text"> <i class="fas fa-map-market-alt"></i> &nbsp;  Plot No. 6/A, 719/D, Corporation House, Near Durgamata Mandir,
                        Sadar, Nagpur - 440001. </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp;    9892963807.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 8.png" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Innovation Employment Solutions</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp  Innovation Solutions, 1st Floor, Apparao Building, Punjabi Line, Behind Singh Sabha Gurudwara, Kadbi
                        Mecosabagh, Nagpur - 440004. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 7057373847.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 9.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        JobsClass.com</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;     Plot No.27 Aatre Leyout,
                        Ranapratap Nagar, Nagpur - 440022.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   9271629449.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 100.jpg" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Maharojgar Newspaper Media and Outsourcing Consultancy</h5>
                      <p class="card-text"><i class="fas fa-map-marker-alt"></i>&nbsp;  248, 1St Floor, Karotiya Bhavan, Canal Road, Behind Times of India,
                        Dharampeth, Nagpur - 440010. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;    9168849977.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry">
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civilk.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        PSuite Careers Pvt Ltd</h5>
                        
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  S-6, 2nd Floor, Girish heights, Near LIC square Nagpur
                        Bureau Of Mines, Nagpur - 440001.</p>
                        <p class="card-text">  7972111519.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/civil 12.jpg" style="padding: 5px 5px;"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Strategic Hr Services</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; Sunraj Bhaskar Complex, Pratap Nagar,
                        Parsodi, Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 8850413640.</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
