            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/deal 1.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Harshal Motors
                                    </h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">0712-2241941</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371490079" itemprop="telephone">8779923197.</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:info@cherriesnchillies.com">harshalmotors96@gmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://www.harshalmotors.com/" rel="nofollow">http://www.harshalmotors.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">Plot no.85, Hindustan Colony, Wardha Road, Near kothari Hospital,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"> Chhatrapati Nagar Square,</span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode"> 440015.</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>Harshal Motors :- Plot no.85, Hindustan Colony, Wardha Road, Near kothari Hospital,Nagpur.
                        </br>
                            Harshal Motors Is One Of The Best Service Station In Nagpur. We Deal In Car Parts And provide Multi Car Services.
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/deal info1.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/deal info 2.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/deal info 3.jpg" alt="Third slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/deal info 4.jpg" alt="Forth slide" slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/deal info 5.jpg" alt="Fifth slide">
                                  </div>
                                </div>
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Multi Car Service Station</a>
                            <a href="" class="btn btn-light m-1"> Car Part Dealers</a>
                            <!-- <a href="" class="btn btn-light m-1">Bungalow</a>
                            <a href="" class="btn btn-light m-1">Row House</a>
                            <a href="" class="btn btn-light m-1">Residential Plots</a>
                            <a href="" class="btn btn-light m-1">Commercial Properties</a> -->
                        </div>
                    </div>
                </div>
