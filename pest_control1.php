          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="img/pest control 22.jpg" alt="Image">
        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <!-- <div class="card mb-3" style="max-width: 1000px; margin-left: 75px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal11.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Samruddhi Pest Control</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;   near Police station, Adhartal, Jabalpur, Madhya Pradesh 482004</p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;
                    09977536851.</p>
                      <a href="dealeraInfo.php">More info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 100px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="pestcontrol2.php"><img src="img/pestcontrol.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Samruddhi Pest Control</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;near Police station, Adhartal, Jabalpur, Madhya Pradesh 482004.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  09977536851</p>
                        more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
