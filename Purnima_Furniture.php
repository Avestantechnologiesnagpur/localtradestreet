                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/PurnimaFurniture.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Purnima Furniture </h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">099750 78557</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">099750 78557</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">purnimafurniture.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.purnimafurniture.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">lane No 2, Maldhaka, Quata Colony, Bhandara Road, Lakad Ganj </span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode"> 440008</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">10.00am - 11:00pm </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">10.00am - 11:00pm </span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">10.00am - 4:00pm</span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">10.00am - 11:00pm </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">10.00am - 11:00pm </span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">10.00am - 11:00pm  </span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">10.00am - 11:00pm</span></td></tr>		</tbody></table>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                     ...
                     <h3 class="text-danger mb-3">Description</h3>
                        <p>" Purnima Furniture in Lakad Ganj, Nagpur is a reliable name in the industry as they aim to deliver the best experience to their customers. This has helped them build up a loyal customer base. They started their journey in 2011 and ever since, they have ensured that the customer remains at the centre of their business operations and philosophy. As they are located in a favourable neighbourhood, exactly at Lane No 2 , Maldhaka, Quata Colony, Lakadganj Police Station , Maldhaka, Bhandara Road, Lakad Ganj-440008 near Lakadganj Police Station , Maldhaka, it is easy to locate Purnima Furniture on the map. For any kind of assistance or questions, it is best to contact them directly during their business hours. "
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/PurnimaFurniture.jpg" alt="First slide">
                                  </div>
