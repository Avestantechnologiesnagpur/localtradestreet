          ...
          <div class="container mt-5">
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Laxmi Furniture</a>
                      </h5>
            ...
            <<div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                   <a href="Asha_Furniture.php"> <img src="img/asha.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Asha Furniture</a>
                      </h5>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 75px;">
                <div class="row g-0">
                  <div class="col-md-4">
                   <a href="AyanshPlywood.php"> <img src="img/Ayansh.jpeg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Ayansh plywood & doors </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; Shop No 2 Sai Plaza Appartment, Lakad Ganj, Nagpur-440008, kachi Oswal Bawan Sardar Vallabh Bhai Patal Ground </p>
             ...
             <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="KesarPlywood.php">  <img src="img/Kesar.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                       Kesar plywood & doors</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; Plot No.37, Bhandara Road, Lakad Ganj, Nagpur-440008, Opposite Police Station  </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9423628761</p>
                        More info</a>
                      </div>
          ...
          <!-- </div>
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
             ...
             <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                   <a href="OmakrMarketing.php"> <img src="img/Omkar.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Omkar Marketing( a house of plywood & laminates)</h5>
                        
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; Omkar House, behind Maruti Waffers Tigrania Rd,, Dwarka, Nashik, Maharashtra 422011
                    </p>
                        <p class="card-text">9822871881.</p>
                        More info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
             ...
             <!-- <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                   <a href="DaimondFurniture.php"> <img src="img/diamond.avif" style="padding: 5px 5px;"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
