    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/fit banner1.jpg" alt="Image">
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/fit 22.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Reactive Physiotherapy And Fitness Clinic.</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:9422842330" itemprop="telephone"8600474988></a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">8600052998</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:reactivefitnessclub@gmail.com">reactivefitnessclub@gmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://reactivefitnessclub.com/" rel="nofollow"> http://reactivefitnessclub.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;"> Saikrupa Apartment, Umred Rd, beside chaudhary Hospital ,Old Mirchi Bazaar square, Sakkardara,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"> Nagpur</span>, <span itemprop="addressRegion"style="color:#ff1717;">Maharashtra</span> - <span style="color:#ff1717;" itemprop="postalCode">440024</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        Saikrupa Apartment, Umred Rd, beside chaudhary Hospital ,Old Mirchi Bazaar square, Sakkardara, Nagpur, Maharashtra-440024.
                        <br>"pain management arthritis pain spine care muscle stiffness pre and post pregnancy sessions pilates aerobics and floor exercise sessions complete fitness and rehabilitation"
</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/fit8.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/fit9.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/fit10.jpg" alt="Third slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                     ...
                     <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Pivd</a>
                            <a href="" class="btn btn-light m-1">Geriatric Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Pain Relief</a>
                            <a href="" class="btn btn-light m-1">Hand Therapy</a>
                            <a href="" class="btn btn-light m-1">Manual Therapy</a>
                            <a href="" class="btn btn-light m-1">Knee Pain Treatment</a>
                            <a href="" class="btn btn-light m-1">Neck Pain Treatment</a>
                        </div>
                    </div> 
                </div>
