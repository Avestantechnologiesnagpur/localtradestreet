                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/car 33.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Ranchi car detailing
                                    </h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                        ...
                                        </a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371490079" itemprop="telephone"> 070002 52915.</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:contact@ranchicardetailing.com">contact@ranchicardetailing.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://www.ranchicardetailing.com/" rel="nofollow"> http://www.ranchicardetailing.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">Near Haj House, kadru, Road No-1,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">Ashok Nagar</span>, <span itemprop="addressRegion"style="color:#ff1717;">Ranchi</span> - <span style="color:#ff1717;" itemprop="postalCode"> 834002</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/rachicar.jpg" alt="First slide">
                                  </div>
