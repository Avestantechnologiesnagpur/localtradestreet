       ...
       <!-- Carousel End -->
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="babycareInfo.php"><img src="img/mohakbaby.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Mohak Baby Day Care</h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Plot No 17 Bhaskar Govindam, appt Borkute Layout
                        Narendra Nagar Nagpur
                        Nagpur, Maharashtra 440015.</p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;    7276334778.</p>
                      more info</a>
                    </div>
