    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/wed banner 1.png" alt="Image">
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/wed 11.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Sanjivan Sabhagruh and Lawn</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:9422842330" itemprop="telephone">78210305231</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">78210305231</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:sanjivansabhagrah@gmail.com">sanjivansabhagrah@gmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://sanjivansabhagrah.com/" rel="nofollow"> http://sanjivansabhagrah.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">  Near Budha Bhumi, Khairi, Kamptee Rd,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"> Nagpur</span>, <span itemprop="addressRegion"style="color:#ff1717;">Maharashtra</span> - <span style="color:#ff1717;" itemprop="postalCode">441001</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        The Sanjivan Hall and Lawn located in Kamptee road, Nagpur has Banquet Halls, Wedding Lawns, Party Halls, Party Plots, Marriage Halls. Lawn can accomodate upto 1000 guests in seating and 1500 guests in floating. Hall can accomodate upto 650 guests in seating and 1000 guests in floating.
Vegetarian food is served at this venue. Features of this wedding venues are : Food provided by the venue, Outside food/caterer allowed at the venue, Ample parking, Baarat allowed, Fire crackers allowed, Hawan allowed, Overnight wedding allowed, Decor provided by the venue, Packages starts at Rs 400 per plate for vegetarian menu and at Rs N/A for non veg menu.
</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/wed5.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/wed6.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/wed7.jpg" alt="Third slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                     ...
                     <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Photographers</a>
                            <a href="" class="btn btn-light m-1">Caterers</a>
                            <a href="" class="btn btn-light m-1">Makeup Artists</a>
                            <a href="" class="btn btn-light m-1">Rentals</a>
                            <a href="" class="btn btn-light m-1">DJs</a>
                            <a href="" class="btn btn-light m-1">Decorators</a>
                            <a href="" class="btn btn-light m-1">Invitation Cards</a>
                        </div>
                    </div> 
                </div>
