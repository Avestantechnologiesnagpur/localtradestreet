    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase"> wedding Details </h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">cateres Details</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/sabrosa.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Kohinoor Electronics</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9325410033</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">9371513961</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">info@sabrosacateres.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.sabrosakateres.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">258. Opposite, chapde Lawns..</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode">440010</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">10:00am - 8:00am </span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">Closed - Closed </span></td></tr>		</tbody></table>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>"Food is not just an appetite for us; in fact, food for SABROSA synonym of Tasty is an emotion, which is expressed with extra care to one and all. We at SABROASA believe in feeding the tastiest, top-notch quality of food at an economical value. Food being a basic need we make sure that our plethora of options in both vegetarian and non-vegetarian varieties is served cost-effectively.
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/sabrosa.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sabrosa.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sabrosa.jpg" alt="Third slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sabrosa.jpg" alt="Forth slide" slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/sabrosa.jpg" alt="Fifth slide">
                                  </div>
                                </div>
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Photo Studios in Nagpur</a>
                            
                             
                            
                           
                            <a href="" class="btn btn-light m-1">Marriage Bureaus in Nagpur</a>
                            <a href="" class="btn btn-light m-1">Caterers</a>
                            <a href="" class="btn btn-light m-1">Banquet Halls in Nagpur</a>
                            <a href="" class="btn btn-light m-1"> Mandap Decorators in Nagpur</a>
