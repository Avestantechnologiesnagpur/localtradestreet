    ...
    <body>
        ...
        <!-- Navbar End -->
         ...
         <!-- Header start -->
          ...
          <div class="container-fluid page-header bgschool">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase"> College Details</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">College Detail</p>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="container mt-5">
            ...
            <div class="card mb-3 pb-5 pt-5" style="max-width: 1000px; margin-left: 10px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="sci1info.php"> <img src="img/cindrebay1.png" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Cindrebay School Of Design</h5>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Plot no. s-17, Aath Rasta Chowk,
                        Nagpur - 440010 </p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                       7123567577,    9895776441</p>
                      <a href="restinfo.php">More info
      </a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/sonekar.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Sonekar Group Of Institutions </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Devi Road, Mahadula,
                         Nagpur - 440016.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 0712-263780, 0712-2758789</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/govindrao.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Govindrao Wanjari Collage Of Education
                      </h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Survey No. 156, Near Butibori
                         Nagpur - 440010. </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp; 7103-326699, 9371110437.</p>
                      <a href="">more info</a>
                    </div>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/george.jpeg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        St. George Convent School & Jr. Collage </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  Besa Road, Near SBI Bank, 
                         Nagpur - 440001 </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/vijay.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Vijay Collage Of Science Art And Commerce
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Wardha Road,
                         Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/aakar.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Aakar Collage</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7&8 Near Sandaman Lawn,
                         Nagpur - 440010. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 7722088202.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/acharya.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Acharya Vinoba Bhave Institute Of Technology Pawnar </h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7&8 Yashwant Stadium,
                         Nagpur - 440012. </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp; 7447581158.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/AI.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        AI Ameen Junior Collage</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp Plot No. 162, Opposite Eidgah Ground,
                         Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9326517011.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/arts.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Arts. Comm. & Sci. Collage</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;   Arvi, Nagpur City,
                        S Nagpur - 440001. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/bhavbhuti.jpg" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Bhavbhuti Science Collage</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; 7&8 Devri Road, Nagpur GPO,  
                        Nagpur - 440016. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 3698745211</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry">
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/biyani.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Biyani Group Of Collage</h5>
                        
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; R-4, Nagpur,
                         Nagpur - 440010.
                    </p>
                        <p class="card-text">8890290151.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
          ...
          <div class="row pt-5">
              ...
              <div class="col-lg-3 col-md-6 mb-5">
                  ...
                  <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white-50 mb-2" href="login.php"><i class="fa fa-angle-right mr-2"></i>Login</a>
