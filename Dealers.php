        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 75px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="dealeraInfo.php"> <img src="img/deal11.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;   Plot no.85, Hindustan Colony, Wardha Road, Near kothari Hospital,
                        Chhatrapati Nagar Square, Nagpur - 440010 </p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                    7020135134,   8779923197.</p>
                    More info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 2222.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Nagpur Auto Works</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  1020, A. B. C. Tower, CA Road, Near Telephone Exchange, Rampeth,
                        Wardhaman Nagar, Nagpur - 440016.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9372877776</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 3.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        nagpur Auto Works Car <A class="C"></A></h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Plot no 1020, Central Ave Rd, A. B. C. Tower,Telephone Exchange Chowk, Rampeth, Queta Colony, Hansapuri,
                        Wardhaman Nagar , Nagpur - 440010. </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;   09823973323.</p>
                      <a href="">more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 4.jpg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        SHREE AUTO DEALS & FINANCE</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  Ramna Maroti Nagar, Plot No. 10, Opposite Indraprast Hotel, New Nandanvan Road, Near Ishwar Nagar Sq, Nagpur - 440001 </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9371771924.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 55.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Bombay Car Link
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; C-13-14, Anjuman Complex, Mangalwari Road, Sadar Bazar, Haldiram Sweet Shop,
                        Sadar, Nagpur - 440010. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 6.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Maharashtra Auto Sales Corporation</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Wadi Road,
                        Wadi, Nagpur - 440010. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9764228619.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 7.jpg" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        A K GANDHI CARS</h5>
                      <p class="card-text"> <i class="fas fa-map-market-alt"></i> &nbsp; A 24/25 Shop 23, Main Road Nagpur, Untkhana Chowk Near Dainik Bhaskar Baidyanath Square
                        Nagpur - 440024. </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp;   8983061001, 8983061002.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/deal 88.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Akshad Automobile</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp Hanuman Mandir Road, Near Saoli Hospital,
                        Dharampeth, Nagpur - 440010. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9823004429.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
