          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="img/mechanic.jpg" alt="Image">
       ...
       <!-- Carousel End -->
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-right: 55px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="carmechanicInfo.php"><img src="img/car 11.JPG" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;   Shop No.3,4,5,Neelkamal Housing Society,central Bazar Road, Nagpur - 440010.</p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                    0712-2233793 , 9822643326.</p>
                      More info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="carmechanicInfo2.php"><img src="img/car 22.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        We VOLTS Electricals</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp; Shop No. - 210, 1st Floor R.R. Plaza, Opposite Santushti Appartment Church Road
                        Lower Bazaar
                        Ranchi, Jharkhand 834001.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 07000252915.</p>
                        more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="carmechanicInfo3.php"><img src="img/car 33.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Ranchi car detailing <A class="C"></A></h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Near Haj House, kadru, Road No-1
                        Ashok Nagar
                        Ranchi, Jharkhand 834002</p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;    091134 45098.</p>
                      more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Gulf Car Stop</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;  277, Lokseva Nagar, Near Mokhare College,
                        Bhamti, Nagpur - 440022.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;    7020131217.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">JMD Auto</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Ring Road,
                        Binaki, Nagpur - 440017. </p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Kawle Light House</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; New Subhedar Nagar, Thawre Colony,
                        Ashirwad Nagar, Nagpur - 440024.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  8390738394.
                        </p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Mahalaxmi Scooters</h5>
                      <p class="card-text"> <i class="fas fa-map-market-alt"></i> &nbsp;  Near kachore lawn, Beltarodi Road,
                        Manish Nagar, Nagpur - 440015.
                    </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp;     9372883325.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Prashant Engineering Company</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp  Shani Mandir Road, Opposite ITI,
                        Sitabuldi, Nagpur - 440012.</p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9579118971</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Services Head Repair & Service Center</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;     49, Ring Road, BabulKheda, Narendra Nagar, Suyog Nagar,
                        Narendra Nagar, Nagpur - 440015.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   7666763249.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        The United Engineering Company</h5>
                      <p class="card-text"><i class="fas fa-map-marker-alt"></i>&nbsp;  Pt.Malvia Road, Shani Mandir Road, Opposite ITI,
                        Sitabuldi, Nagpur - 440012.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;   9822264078.  </p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry">
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;   Dhanshree Appartment, P!ot No.9, Shop No.2, Ring Rd, Pratap Nagar,
                        Bhamti, Nagpur - 440022.</p>
                        <p class="card-text">  9975946844.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Bridgestone Select</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; 67, Ring Road, Kotwal Nagar,
                        Ranapratap Nagar, Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp;  7276023456.</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
