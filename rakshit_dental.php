            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/denties 7.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Rakshit Dental Clinic</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9425542366</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">9158559942</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:rakshitdentalclinic@mail.com">rakshitdentalclinic@mail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://rakshitdentalclinic.com/" rel="nofollow"></a> http://rakshitdentalclinic.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">  Mission Hospital Rd, Juni Line,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">Bilashpur</span>, <span itemprop="addressRegion"style="color:#ff1717;">Chattisgarh</span> - <span style="color:#ff1717;" itemprop="postalCode">495001</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>Rakshit Dental Clinic and Orthodontics in Mission Hospital Road, Bilaspur-chhattisgarh
                        <br>
                            </p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/rakshit 1.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/rakshita 2.jpg" alt="Second slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Dental Sealant</a>
                            <a href="" class="btn btn-light m-1">Teeth Laminate Treatment</a>
