            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/cindrebay.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Cindrebay School Of Design</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9895776441</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">9371513961</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">info@cindrebayschool.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.cindrebayschool.com/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">s-17, Aath Rasta Chowk, Nagpur</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Nagpur</span> - <span style="color:#ff1717;" itemprop="postalCode">440010</span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">10:00am - 5:00am </span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">Closed - Closed </span></td></tr>		</tbody></table>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>At Cindrebay, we value experiences and integrative learning. Apart from acquiring University certified degree and diplomas, students stand a chance to gather practical know-how and market insights in Interior Design, Fashion Design, Animation and Multimedia courses. Cindrebay has become a distinct center of design learning owing to our flexible study programs which let students chose their path instead of forcing them into boxes. 
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/cindrebay 2.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/cindrebay 3.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/cin 4.png" alt="Third slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/cin 5.jpg" alt="Forth slide" slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/cindrebay.jpg" alt="Fifth slide">
                                  </div>
                                </div>
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Pacement/ Internship</a>
                            <a href="" class="btn btn-light m-1">WiFi Campus</a>
                            <a href="" class="btn btn-light m-1">Personalized Attention</a>
                            <a href="" class="btn btn-light m-1">In Hours Publication</a>
                            <a href="" class="btn btn-light m-1">Scholarship</a>
                            <a href="" class="btn btn-light m-1">Fashion Show</a>
                        </div>
                    </div>
                </div>
