        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="bank3.php"> <img src="img/malakapur.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        The Malkapur Urbon Co-Op. Bank  Ltd.</h5></a>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Dongrey Layout
                        Nagpur - 440010 </p>
