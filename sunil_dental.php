            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/+hospital 2.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Dr. Sunil Chauhan laser Dental Clinic</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">0712-2241941</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">9371513961</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:drsunilsinghchauhan777@gmail.com">drsunilsinghchauhan777gmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://drsunilsinghchauhan777.com/" rel="nofollow"></a> http://drsunilsinghchauhan777.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;"> Office no 1, Ground Floor , Rajul Complex Near dargah , Aaga Chowk,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;">Jabalpur</span>, <span itemprop="addressRegion"style="color:#ff1717;">Madhya Pradesh</span> - <span style="color:#ff1717;" itemprop="postalCode"> 482002</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>CHAUHAN LASER DENTAL CLINIC & ORTHODONTIC CENTRE<br>
                            Near Allahabad ATM, Dhanwantri Nagar, Chauraha, Jabalpur, Madhya Pradesh 482003,
</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/sunil 1.jpg" alt="First slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">dental Filling</a>
                            <a href="" class="btn btn-light m-1">Orthodontics</a>
                            <a href="" class="btn btn-light m-1">Tooth Extraction</a>
                            <a href="" class="btn btn-light m-1">Complete Dentures</a>
                            <a href="" class="btn btn-light m-1">Parital Denture</a>
                            <a href="" class="btn btn-light m-1">Dental Jewellery</a>
                            <a href="" class="btn btn-light m-1">Teeth Whitening</a>
                            <a href="" class="btn btn-light m-1">Dental X-Rays</a>
                            <a href="" class="btn btn-light m-1">Dental implants</a>
                            <a href="" class="btn btn-light m-1">Apisectomy</a>
                            <a href="" class="btn btn-light m-1">Gum Treatment</a>
