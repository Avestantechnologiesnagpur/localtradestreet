          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="img/real state 1.jpg" alt="Image">
        ...
        <!-- <div class="jumbotron wrapper">
          ...
          <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-left: 75px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="commercialInfo.php"> <img src="img/commercial 1.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                      ...
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp;  Anupawa Building, Adwani Square,
                        Jaripatka, Nagpur - 440010 </p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                       0712-2241941,    9326515757.</p>
                      More info</a>
                    </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 2.jpg" width="320px" height="220px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Maa Bindhyawasni Developers</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Pipla Fata,Hudkeshwar Road,
                        Hudkeshwar BK, Nagpur - 440016.</p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9028493645</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px;" class="fa" >&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 3.jpg " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Google Lands & Builders</h5>
                    
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp;  Bhim Chowk, Bada Indora, Above Laxmi Photo Studio,
                        Jaripatka, Nagpur - 440010. </p>
                      <p class="card-text"> <i class='fas fa-tty'></i>&nbsp;  9168035888.</p>
                      <a href="">more info</a>
                    </div>
                    <div class="getenquiry" style="margin-bottom: 25px; margin-left: 20px;">
                      <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3"  style="max-width: 1000px; margin-left: 195px;" >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial44.jpeg" style="height: 250px; margin-bottom: 20px; padding: 5px 5px;"   class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Onkar Real Estate</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; 39, Vidhaya Nagar, Near Fire Collage,
                        Katol Road, Nagpur - 440001 </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 8806400850.</p>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/ratan12.jpg" style="margin-top: 20px; height: 230px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">Ratan Consultancy
                      </h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i> &nbsp; Shop No 1, Plot No. 5, Near Reliance Fresh, Opposite United Bank,
                        Manish Nagar, Nagpur - 440010. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp;
                            9823984626, 7020130350</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 6.jpg" style="height: 250px; padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Shree Gajanan Builders And Developers</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; Plot no 13, Gajanan Orchit, Flat no 101, Gokul society, Gorewada Road Opp Blue Diamond School,
                        Gorewada, Nagpur - 440010. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9422441667.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 7.webp" style="height:250px ; padding: 10px 7px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Sidd Infrastructure</h5>
                      <p class="card-text"> <i class="fas fa-map-market-alt"></i> &nbsp; 80, Gajanan Nagar, Wardha Road,
                        Chhatrapati Nagar Square, Nagpur - 440012. </p>
                        <p class="card-text"><i class='fas fa-tty'></i>&nbsp;  9595950899.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" style="margin-bottom: 20px; margin-left: 10px;">
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 8.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Vedant Properties</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp Plot no. 4,Central Railway Colony, Near Chakrapani Maha Vidyalaya, Omkar Nagar
                        Bhagwan Nagar, Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9372303930.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 9.jpg" style="height: 250px;padding: 5px 5px" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Wainganga Realtors</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp;   Flat No.6, Building No.2, Harsh Co-Operative Society, Near Orange City Hospital, Dev Nagar
                        Khamla, Nagpur - 440001. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9423554792.</p>
                        <a href="">more info</a>
                      </div>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 10.jpg" style="height: 250px;padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Bhumi Consultancy</h5>
                      <p class="card-text"><i class="fas fa-map-marker-alt"></i>&nbsp;  Plot No.12, Samaj Bhushan Society, UCO Bank Road,
                        Manish Nagar, Nagpur - 440016. </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp;  9890036512.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry">
                        <button type="button" style="border-radius: 10px; margin-bottom: 20px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 11.jpg" style="padding: 5px 5px;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Ashok Vatika Real Estate</h5>
                        
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  Mouza Hulkeshwar, Near Narsala Grampanchayat,
                        Narsala, Nagpur - 440010.
                    </p>
                        <p class="card-text">8888055515.</p>
                        <a href="https://www.pickeronline.com/nagpur/cherries-n-chillies-international-cuisine-restaurant">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
            ...
            <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="img/commercial 12.jpg" style="padding: 5px 5px;"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Rising Infra Estate</h5>
                      <p class="card-text"><i class='fas fa-map-marker-alt'></i>&nbsp; Opp. Hotel Heritage, Near Balaji Nagar, Bus Stop,
                        Hingna, Nagpur - 440022. </p>
                        <p class="card-text"><i class='fas fa-tty'></i> &nbsp; 9130169381, 7218204691.</p>
                        <a href="">more info</a>
                      </div>
                      <div class="getenquiry" >
                        <button type="button" style="border-radius: 10px;" class="btn btn-primary btn-lg"><i style="font-size:24px" class="fa">&#xf0e0;</i> &nbsp;  Get-Enquiry</button>
