                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/Sofa.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Sofa Emporium  </h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:0712-2241941" itemprop="telephone">9823204311</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9371513961" itemprop="telephone">9823204311</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:">info@sofaemporium.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href="http://" rel="nofollow">http://www.sofaemporium.in/</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">Main Road Urkura, Opposite Siddhivinayak Hospital, Raipur </span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"></span>, <span itemprop="addressRegion"style="color:#ff1717;">Chattisgarh-492003
                    </p></span> - <span style="color:#ff1717;" itemprop="postalCode"></span>.</li>
                                      </ul> 
                                      <div class="row pt-3">
                            ...
                            <p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores
                                ...
                                <div class="col">
                                    ...
                                    <table style="margin:auto;" class="table table-bordered">
                                        <tbody><tr><td>Mon </td><td><span style="font-size:12px;">10.00am - 7:30pm </span></td></tr><tr><td>Tue </td><td><span style="font-size:12px;">10.00am - 7:30pm  </span></td></tr><tr><td>Wed </td><td><span style="font-size:12px;">10.00am - 7:30pm  </span></td></tr><tr><td>Thu </td><td><span style="font-size:12px;">10.00am - 7:30pm  </span></td></tr><tr><td>Fri </td><td><span style="font-size:12px;">10.00am - 7:30pm  </span></td></tr><tr><td>Sat </td><td><span style="font-size:12px;">10.00am - 7:30pm   </span></td></tr><tr><td>Sun </td><td><span style="font-size:12px;">10.00am - 7:30pm  </span></td></tr>		</tbody></table>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                     ...
                     <h3 class="text-danger mb-3">Description</h3>
                        <!-- <p> "Metro Furniture City in Aurangabad-maharashtra is one of the leading businesses in the Furniture Dealers. Also known for Furniture Dealers, Furniture Manufacturers, Furniture Dealers (Economy), Furniture Dealers (Premium), Sofa Dealers, Modular Kitchen Dealers, Wooden Furniture Dealers, Office Chair Dealers and much more. Find Address, Contact Number, Reviews & Ratings, Photos, Maps of Metro Furniture City, Aurangabad-maharashtra."
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/Sofa.jpg" alt="First slide">
                                  </div>
				...
				<div class="clearfix"></div>
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            ...
                            <a href="" class="btn btn-light m-1">Sofa Manufacturing</a>
                            <a href="" class="btn btn-light m-1">Sofa Dealer</a>
