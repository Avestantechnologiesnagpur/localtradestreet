                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <img class="img-fluid w-100" src="img/fit 44.jpg" alt="Cherries">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="container">
                                <div class="header">
                                    <h1 itemprop="name">Om Physiotherapy Clinic and Fitness Centre</h1>
                                      <ul class="list-group b-info" style="margin-bottom: 4px; ">
                                          ...
                                          <li class="list-group-item"><i class='fas fa-phone'></i> <a href="tel:9422842330" itemprop="telephone">06263066692</a>.</li><li itemprop="telephone" class="list-group-item"><i class='fas fa-mobile-alt'></i> <a href="tel:9326863318" itemprop="telephone">06263066692</a>.</li> <li itemprop="email" class="list-group-item"><i class='fas fa-envelope-open'></i> <a href="mailto:omphysiotherapy@gmail.com">omphysiotherapy@gmail.com</a></li><li class="list-group-item"><i class="fa fa-globe"></i> <a itemprop="sameAs" target="_blank" href=" http://omphysiotherapy.com/" rel="nofollow"> http://omphysiotherapy.com</a></li><li class="list-group-item" itemprop="address"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <span itemprop="streetAddress" style="color:#ff1717;">beside Nalanda Public School, Dhanvantari Nagar,</span><br>&nbsp; &nbsp;&nbsp; <span style="color:#ff1717;" itemprop="addressLocality" style="color:#ff1717;"> Jabalpur</span>, <span itemprop="addressRegion"style="color:#ff1717;">Madhyan pradesh</span> - <span style="color:#ff1717;" itemprop="postalCode">482002</span>.</li
                                      </ul> 
                                      <div class="row pt-3">
                    ...
                    <div class="mb-5">
                        ...
                        <div class=" col">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/fit14.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/fit15.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="img/fit16.jpg" alt="Third slide">
                                  </div>
                                  <!-- <div class="carousel-item">
				...
				<div class="clearfix"></div>
                     ...
                     <div class="mb-5 pt-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Low Back Pain</a>
                            <a href="" class="btn btn-light m-1">Geriatric Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Pediatric Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Frozen Shoulder Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Cervical Spondylosis Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Treatment For Orthopaedic Physiotherapy</a>
                            <a href="" class="btn btn-light m-1">Cardiovascular and Pulmonary Physiotherapy</a>
                        </div>
                    </div> 
                </div>
