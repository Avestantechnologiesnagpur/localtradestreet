<DOCTYPE html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Beauty Parlour info</title>
          ...
          <div id="header-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100 h-300" src="img/marvelousmain.jpg" alt="Image">
                  ...
                  <div class="carousel-item">
                      <img class="w-100" src="img/marvelousmain.jpg" alt="Image">
                      <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
        ...
        <!-- <div class="jumbotron wrapper">
           ...
           <div class="container mt-5">
            <div class="card mb-3" style="max-width: 1000px; margin-right:5px;">
                <div class="row g-0">
                  <div class="col-md-4">
                  <a href="beautyparlour2.php"> <img src="img/marvelous.jpg" class="img-fluid w-100" alt="..." >
                  </div>
                  <div class="col-md-8">  
                    <div class="card-body">
                      <h5 class="card-title">
                        Maevelous Beauty  Care Center</h5></a>
                        <span class="glyphicon glyphicon-envelope"></span>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i> &nbsp; R-180 Dattatraya Appartment reshimbagh nagpur 440009
                         </p>
                      
                  <p class="card-text"><i class='fas fa-tty'></i> &#xf095;</i>
                       9822941130/ 7507777831</p>
                     More info</a>
                    </div>
             ...
             <div class="card mb-3" style="max-width: 1000px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="beautyparlour3.php"> <img src="img/jasmin.jpg" width="320px" height="300px" style="padding: 5px 5px;" img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">
                        Jasmine Beauty parlour & Make-up Studio</h5>
                      <p class="card-text"> <i class='fas fa-map-marker-alt'></i>&nbsp;  opp. Punjabi national bank, plot no. 10, chandika nagar manewada road 
                          Gujrat- </p>
                        <p class="card-text"> <i class='fas fa-tty'></i> &nbsp; 9922431221</p>
                        more info</a>
                      </div>
            ...
            <!-- <div class="card mb-3" style="max-width: 1000px; padding:5px 5px; margin-left: 195px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <a href="packer4.html"> <img src="img/sai.webp " width="300px"  class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
